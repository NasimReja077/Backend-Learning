...
// Why .then() and .catch()?
// /?.then() ensures clear chaining of multiple
// asynchronous operations.
// /?.catch() centralizes error handling, making it easy to
// debug and manage failures.
//
// * ---------------------------------------------------------------------------------- *
...
// * ---------------------------------------------------------------------------------- *
// * Read a File: fs.promises.readFile
// Reads the content of a file asynchronously.
// * The readFile() method reads the entire contents of a file.
//
...
// * It can return the data as a Buffer or string based on the
// encoding provided.
// 
...
fs.promises
.appendFile(filePath, "\nThis is the appended updated data", "utf-8")
